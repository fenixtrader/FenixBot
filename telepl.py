        ...
        for gtid in sorted(poloResults.keys())[-latestTrades:]:
            ...
            if want_pictures:
                if poloResults[gtid]['type'].upper() == "BUY":
                    bot.send_photo(chat_id=TG_ID, photo='https://raw.githubusercontent.com/Fenixbot/Imagenes-BUY-SELL/master/buy.png')
                else:
                    bot.send_photo(chat_id=TG_ID, photo='https://raw.githubusercontent.com/Fenixbot/Imagenes-BUY-SELL/master/sell.png')
